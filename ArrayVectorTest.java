...
public class ArrayVectorTest {
    ...
    private final int vl = 5;
    private final int vlTwo = 7;
    private final ArrayVector arrayOne = new ArrayVector(vl);
    private final ArrayVector arrayFive = new ArrayVector(vlTwo);
    private final ArrayVector arraySeven = new ArrayVector(vl);
    ...
    public void testClone() throws CloneNotSupportedException {
        ...
        arrayOne.fillArray(arrayFour);
        ArrayVector expResult = arrayOne;
        ArrayVector result = (ArrayVector) arrayOne.clone();
        assertEquals(expResult, result);
    }
}